...
def build_siamfcpp_tester(task_cfg):
    ...
    # build tester
    testers = tester_builder(parsed_args.video, "track", task_cfg.tester, "tester", pipeline)
    return testers
...
def build_sat_tester(task_cfg):
    ...
    pipeline = pipeline_builder.build('vos',
                                      ...
                                      tracker=tracker)
    # build tester
    testers = tester_builder(parsed_args.video, 'vos', task_cfg.tester, "tester", pipeline)
    return testers
